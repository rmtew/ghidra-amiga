ÄÄ_BUFSIZ 512ÄBUFSIZ 512Ä_NFILE 20
É_iobuf
{
É_iobuf*_next;
éÑ*_ptr;
...
ÅÇrename __ARGS((Ñ*,Ñ*));
ÅÇrmdir __ARGS((Ñ*));
ÅÑ*tmpnam __ARGS((Ñ*));Äabs(x) ((x)<0?-(x):(x))Ämax(a,b) ((a)>(b)?(a):(b))Ämin(a,b) ((a)<=(b)?(a):(b))
