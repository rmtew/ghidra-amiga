€ˆLIBRARIES_DOS_H€LIBRARIES_DOS_HˆEXEC_TYPES_HŒ"exec/types.h"‡€DOSNAME "dos.library"€DOSTRUE (-1L)€DOSFALSE (0L)€MODE_OLDFILE 1005€MODE_NEWFILE 1006€OFFSET_BEGINNING -1€OFFSET_CURRENT 0€OFFSET_END 1€OFFSET_BEGINING OFFSET_BEGINNING€BITSPERBYTE 8€BYTESPERLONG 4€BITSPERLONG 32€MAXINT 0x7FFFFFFF€MININT 0x80000000€SHARED_LOCK -2€ACCESS_READ -2€EXCLUSIVE_LOCK -1€ACCESS_WRITE -1
ƒDateStamp{
’ds_Days;
’ds_Minute;
’ds_Tick;
...
„fib_Comment[80];
„padding[36];
};€FIBB_ARCHIVE 4€FIBB_READ 3€FIBB_WRITE 2€FIBB_EXECUTE 1€FIBB_DELETE 0€FIBF_ARCHIVE (1<<FIBB_ARCHIVE)€FIBF_READ (1<<FIBB_READ)€FIBF_WRITE (1<<FIBB_WRITE)€FIBF_EXECUTE (1<<FIBB_EXECUTE)€FIBF_DELETE (1<<FIBB_DELETE)
¥¡;
¥BSTR;€BADDR(bptr) (((—)bptr)<<2)
ƒInfoData{
’id_NumSoftErrors;
’id_UnitNumber;
’id_DiskState;
