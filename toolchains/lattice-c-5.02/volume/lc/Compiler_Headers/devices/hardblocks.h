...
#define	IDNAME_RIGIDDISK	(((long)'R'<<24)|((long)'D'<<16)|('S'<<8)|('K'))
...
#define	IDNAME_BADBLOCK		(((long)'B'<<24)|((long)'A'<<16)|('D'<<8)|('B'))
...
#define	IDNAME_PARTITION	(((long)'P'<<24)|((long)'A'<<16)|('R'<<8)|('T'))
...
#define	IDNAME_FILESYSHEADER	(((long)'F'<<24)|((long)'S'<<16)|('H'<<8)|('D'))
...
#define	IDNAME_LOADSEG		(((long)'L'<<24)|((long)'S'<<16)|('E'<<8)|('G'))
