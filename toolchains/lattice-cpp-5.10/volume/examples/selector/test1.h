...
UBYTE note_gadSIBuff[65];

struct StringInfo note_gadSInfo = {
	note_gadSIBuff,	/* buffer where text will be edited */
	UNDOBUFFER,	/* optional undo buffer */
	0,	/* character position in buffer */
	65,	/* maximum number of characters to allow */
...
struct Gadget note_gad = {
	NULL,	/* next gadget */
	18,123,	/* origin XY of hit box relative to window TopLeft */
	341,8,	/* hit box width and height */
	NULL,	/* gadget flags */
	...
	(APTR)&note_gadSInfo,	/* SpecialInfo structure */
	NOTE_GAD,	/* user-definable data */
	NULL	/* pointer to user-definable data */
};

UBYTE file_gadSIBuff[33];

struct StringInfo file_gadSInfo = {
	file_gadSIBuff,	/* buffer where text will be edited */
	UNDOBUFFER,	/* optional undo buffer */
	0,	/* character position in buffer */
	33,	/* maximum number of characters to allow */
	0,	/* first displayed character buffer position */
	0,0,0,0,0,	/* Intuition initialized and maintained variables */
	0,	/* Rastport of gadget */
	0,	/* initial value for integer gadgets */
...
struct Gadget file_gad = {
	&note_gad,	/* next gadget */
	19,109,	/* origin XY of hit box relative to window TopLeft */
	233,8,	/* hit box width and height */
	NULL,	/* gadget flags */
	RELVERIFY,	/* activation flags */
	STRGADGET,	/* gadget type flags */
	...
	NULL,	/* first IntuiText structure */
	NULL,	/* gadget mutual-exclude long word */
	(APTR)&file_gadSInfo,	/* SpecialInfo structure */
	FILE_GAD,	/* user-definable data */
	NULL	/* pointer to user-definable data */
};

UBYTE dir_gadSIBuff[65];

struct StringInfo dir_gadSInfo = {
	dir_gadSIBuff,	/* buffer where text will be edited */
	UNDOBUFFER,	/* optional undo buffer */
	0,	/* character position in buffer */
	65,	/* maximum number of characters to allow */
	0,	/* first displayed character buffer position */
...
struct Gadget dir_gad = {
	&file_gad,	/* next gadget */
	20,12,	/* origin XY of hit box relative to window TopLeft */
	233,8,	/* hit box width and height */
	NULL,	/* gadget flags */
	RELVERIFY,	/* activation flags */
	STRGADGET,	/* gadget type flags */
	...
	NULL,	/* first IntuiText structure */
	NULL,	/* gadget mutual-exclude long word */
	(APTR)&dir_gadSInfo,	/* SpecialInfo structure */
	DIR_GAD,	/* user-definable data */
	NULL	/* pointer to user-definable data */
};
...
struct PropInfo scroll_gadSInfo = {
	...
	-1,13792,	/* horizontal and vertical pot values */
	-1,3276,	/* horizontal and vertical body values */
};

struct Image Image1 = {
	0,15,	/* XY origin relative to container TopLeft */
...
struct Gadget scroll_gad = {
	...
	262,24,	/* origin XY of hit box relative to window TopLeft */
...
struct NewWindow NewWindowStructure1 = {
	80,29,	/* window XY origin relative to TopLeft of screen */
	...
	"File Selector Test",	/* window title */
